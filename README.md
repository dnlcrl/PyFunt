...
A simple Pythonic Deep Learning Framework (WIP and CPU only at the moment) inspired by [Torch](http://torch.ch)'s [Neural Networks package](https://github.com/torch/nn)
